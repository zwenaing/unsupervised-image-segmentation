...
def decode(X):
    with tf.name_scope("rectangle10"):
        ...
        with tf.name_scope("batch_normalization1"):
            ...
            normalized_conv1 = tf.nn.batch_normalization(rect1_conv1, mean, variance, None, None, variance_epsilon)
        ...
        with tf.name_scope("batch_normalization2"):
            ...
            normalized_conv2 = tf.nn.batch_normalization(rect1_conv2, mean, variance, None, None, variance_epsilon)
    ...
    with tf.name_scope("rectangle11"):
        ...
        with tf.name_scope("batch_normalization1"):
            ...
            normalized_conv1 = tf.nn.batch_normalization(rect2_conv1, mean, variance, None, None, variance_epsilon)
        with tf.name_scope("conv2"):
        ...
        with tf.name_scope("batch_normalization2"):
            ...
            normalized_conv2 = tf.nn.batch_normalization(rect2_conv2, mean, variance, None, None, variance_epsilon)
    ...
    with tf.name_scope("rectangle12"):
        ...
        with tf.name_scope("batch_normalization1"):
            ...
            normalized_conv1 = tf.nn.batch_normalization(rect3_conv1, mean, variance, None, None, variance_epsilon)
        with tf.name_scope("conv2"):
        ...
        with tf.name_scope("batch_normalization2"):
            ...
            normalized_conv2 = tf.nn.batch_normalization(rect3_conv2, mean, variance, None, None, variance_epsilon)
    ...
    with tf.name_scope("rectangle13"):
        ...
        with tf.name_scope("batch_normalization1"):
            ...
            normalized_conv1 = tf.nn.batch_normalization(rect4_conv1, mean, variance, None, None, variance_epsilon)
        with tf.name_scope("conv2"):
        ...
        with tf.name_scope("batch_normalization2"):
            ...
            normalized_conv2 = tf.nn.batch_normalization(rect4_conv2, mean, variance, None, None, variance_epsilon)
    ...
    with tf.name_scope("rectangle14"):
        ...
        with tf.name_scope("batch_normalization1"):
            ...
            normalized_conv1 = tf.nn.batch_normalization(rect5_conv1, mean, variance, None, None, variance_epsilon)
        with tf.name_scope("conv2"):
        ...
        with tf.name_scope("batch_normalization2"):
            ...
            normalized_conv2 = tf.nn.batch_normalization(rect5_conv2, mean, variance, None, None, variance_epsilon)
    ...
    with tf.name_scope("rectangle15"):
        ...
        with tf.name_scope("batch_normalization1"):
            ...
            normalized_conv1 = tf.nn.batch_normalization(rect6_conv1, mean, variance, None, None, variance_epsilon)
        with tf.name_scope("conv2"):
        ...
        with tf.name_scope("batch_normalization2"):
            ...
            normalized_conv2 = tf.nn.batch_normalization(rect6_conv2, mean, variance, None, None, variance_epsilon)
    ...
    with tf.name_scope("rectangle16"):
        ...
        with tf.name_scope("batch_normalization1"):
            ...
            normalized_conv1 = tf.nn.batch_normalization(rect7_conv1, mean, variance, None, None, variance_epsilon)
        with tf.name_scope("conv2"):
        ...
        with tf.name_scope("batch_normalization2"):
            ...
            normalized_conv2 = tf.nn.batch_normalization(rect7_conv2, mean, variance, None, None, variance_epsilon)
    ...
    with tf.name_scope("rectangle17"):
        ...
        with tf.name_scope("batch_normalization1"):
            ...
            normalized_conv1 = tf.nn.batch_normalization(rect8_conv1, mean, variance, None, None, variance_epsilon)
        with tf.name_scope("conv2"):
        ...
        with tf.name_scope("batch_normalization2"):
            ...
            normalized_conv2 = tf.nn.batch_normalization(rect8_conv2, mean, variance, None, None, variance_epsilon)
    ...
    with tf.name_scope("rectangle18"):
        ...
        with tf.name_scope("batch_normalization1"):
            ...
            normalized_conv1 = tf.nn.batch_normalization(rect9_conv1, mean, variance, None, None, variance_epsilon)
        with tf.name_scope("conv2"):
        ...
        with tf.name_scope("batch_normalization1"):
            ...
            normalized_conv2 = tf.nn.batch_normalization(rect9_conv2, mean, variance, None, None, variance_epsilon)
